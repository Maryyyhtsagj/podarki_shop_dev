...
export const EditGoodsScreen = ({navigation, route}) => {
  ...
  useEffect(() => {
    ...
    setPrice(item.price + '');
    setCount(item.count + '');
    console.log("asd", Array.isArray(item.old[0]))
    setImages(img);
  ...
  const subCategoryFetch = async () => {
    try {
      const response = await axiosInstance.get(
        `/sub-categories?category_id=${category._id}`,
      );
  ...
  const onPressFunc = async () => {
    if (
      ...
      !Object.keys(newImagesArray).length
    ) {
  ...
  const imageFunc = async () => {
    try {
      ...
      console.log('imageRes', imageRes[0])
      ...
      <ScrollView
        ...
        <View
          ...
          <View style={styles.cameraContainer}>
            <ScrollView
              ...
              contentContainerStyle={styles.contScroll}>
              {(images.length + newImagesArray.length) < 5 && <View>
                <TouchableOpacity
                  style={[styles.AddPhotoContainer, {borderColor: photoColor}]}
                  onPress={() => imageFunc()}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputContainer}>
            <View>
              <TouchableOpacity
                style={[globalStyles.row, styles.activeContainer]}
                onPress={() => {
                  setTime('Всегда в наличии');
                  timeFunc('');
                }}>
                <Image
                  source={time === 'Всегда в наличии' ? active : noActive}
                  style={styles.imgAct}
                />
                <Text
                  style={[
              ...
              <TouchableOpacity
                ...
                <Image
                  source={time === 'Время готовности' ? active : noActive}
                  style={styles.imgAct}
                />
                <Text
                  style={[
          ...
          <View style={styles.dropCont}>
            <View style={styles.opacityView}>
              <SelectDropdown
                ...
                defaultButtonText={
                  category.title ? category.title : 'категория'
                }
            ...
            <View style={styles.dropCont}>
              <View style={styles.opacityView}>
                <SelectDropdown
                  ...
                  dropdownStyle={styles.categoryInput}
                  defaultButtonText={
                    subCategory?.name ? subCategory?.name : 'Подкатегория'
                  }
                  rowTextStyle={styles.choosePhotoText}
                  onSelect={selectedItem => {
              ...
              <View style={styles.catCont}>
                ...
                <Image
                  source={category_bottom}
                  style={styles.category_bottom}
                />
              </View>
            </View>
          ) : null}
