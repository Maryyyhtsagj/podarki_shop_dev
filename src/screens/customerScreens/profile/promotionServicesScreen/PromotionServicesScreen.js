  ...
  const axiosFunc = async () => {
    try {
      const response = await axiosInstance.post(
        '/users/profile/seller/subscription',
        {
          value: price,
          store_id: shop._id,
        },
    ...
    <ScrollView style={styles.container} bounces={false}>
      ...
      <View>
        ...
        <Text
          ...
          Услуга продвижения предоставляет вам дополнительные возможности для
          увеличения продаж на платформе. С ее помощью вы можете вывести в ТОП 5
          своих самых лучших товаров, которые будут иметь более высокий
          приоритет в результатах поиска, тем самым больший спрос у покупателей.
          Товары будут показываться рандомно совместно с участниками, кто так же
          приобрел услугу. Срок действия - 5 дней. Проданные товары по услуге
          переходят в стандартный статус.
        </Text>
        {state ? (
          <Text
            style={[
