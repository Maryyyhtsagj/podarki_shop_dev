...
export const ShopDataScreen = ({navigation, route}) => {
  const shop = route.params?.shop
    ? route.params?.shop
    : useSelector(st => st.customer.active_store);
  console.log(shop);
      ...
      <View>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            ...
            ПН-ПТ: {shop?.weekdays?.from}—{shop?.weekdays?.to}
          </Text>
          {shop.weekends.not_working ? (
            <Text
              ...
              СБ-ВС:
              <Text style={[globalStyles.error, styles.closeText]}>
                {' '}
                выходной
              </Text>
            </Text>
            ...
            <Text
              ...
              СБ-ВС: {shop?.weekends?.from}—{shop?.weekends?.to}
            </Text>
          )}
        </View>
