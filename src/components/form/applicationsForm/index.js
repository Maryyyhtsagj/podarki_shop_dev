...
export const ApplicationsForm = ({item, navigation, orders, banner}, index) => {
  return (
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate(ApplicationsDataName, {item, orders, banner})
      }>
      ...
      <View style={[globalStyles.row, styles.rowCont]}>
        ...
        <Text style={[globalStyles.titleText, globalStyles.weightBold]}>
          {item.income.$numberDecimal} р
        </Text>
      </View>
    </TouchableOpacity>
  );
